...
def wff(L): # dummy at the moment, will add this functionality later on (or delete altogether)
	return True
def revert(A):
	if 'o' in A:
		return 'SaP'
...
# returns all and only valid syllogisms
...
def pretty_print():
	...
	print '\end{longtable}'
	print 'Conclusion \"changes\": SaP $\Leftrightarrow$ SoP, SeP $\Leftrightarrow$ SiP'
	print '\end{document}'
